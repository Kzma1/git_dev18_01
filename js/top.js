    var pika;
    document.write( '<img id="enemy" src="../html_中川和磨_34/img/enemy.png" alt="">' );
    document.write( '<img id="pika" src="../html_中川和磨_34/img/pika.png" alt="">' );
    document.write( '<img id="iwa1" src="../html_中川和磨_34/img/iwa.png" alt="">' );
    document.write( '<img id="iwa2" src="../html_中川和磨_34/img/iwa.png" alt="">' );
    document.write( '<img id="iwa3" src="../html_中川和磨_34/img/iwa.png" alt="">' );
    document.write( '<img id="iwa4" src="../html_中川和磨_34/img/iwa.png" alt="">' );
    ...
    function myEnter(){
        ...
        if ( myPassWord == "ジーズ"){
            location.href = "../html_中川和磨_34/index.html";
        }
    }
