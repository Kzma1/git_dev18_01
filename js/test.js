$(function () {
    ...
    $("#firstbutton").click(function(){
        ...
        if(click == 2){
            ...
            if (random == 0){
                $(".randomgu").show().attr('src', '../html_中川和磨_34/img/gu.png').css("opacity",1);
            } else if (random == 1){
                $(".randomgu").show().attr('src', '../html_中川和磨_34/img/cho.png').css("opacity",1);
            } else if (random == 2){
                $(".randomgu").show().attr('src', '../html_中川和磨_34/img/pa.png').css("opacity",1);
            } 
            $(".randomcho").hide()
            $(".randompa").hide()
        }
